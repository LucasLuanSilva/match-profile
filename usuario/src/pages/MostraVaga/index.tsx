    ...
    return(
        <View>
            ...
            <View style={styles.containerText}>
                <Text style={styles.text}>Envie o currículo do seu perfil ou se preferir, anexe um currículo personalizado abaixo</Text>
                <Text style={styles.text}>Boa Sorte!!!</Text>
            </View>
            <View style={styles.containerButton}>
              <Button style={{ width: '98%' }} onPress={async () => { console.log("Rota") }}>
                Enviar
              </Button>
            </View>
        </View>
